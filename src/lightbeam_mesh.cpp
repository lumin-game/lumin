...
bool LightBeamMesh::init()
{
	...
	vertex.position = { m_lightRadius, 0, -0.02f };
	vertices.push_back(vertex);
	vertex.position = { m_lightRadius, 10, -0.02f };
	vertices.push_back(vertex);
	vertex.position = { 1, 0, -0.02f };
	vertices.push_back(vertex);
	vertex.position = { 1, 10, -0.02f };
	vertices.push_back(vertex);
...
void LightBeamMesh::draw(const mat3& projection)
{
	transform_begin();
